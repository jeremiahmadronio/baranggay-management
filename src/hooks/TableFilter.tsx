  ...
  return (
    ...
    >
      <div className="flex flex-col lg:flex-row gap-3 items-end w-full">
        ...
        {/* Dropdown Filters */}
        {filters.map((filter) => (
          <div key={filter.key} className="flex-1 min-w-[130px] w-full">
            <label className="block text-sm font-medium text-gray-700 mb-1">
              {filter.label}
            </label>
            <select
        ...
        {/* Buttons Group */}
        <div className="flex items-center gap-2 pt-1 flex-shrink-0 w-full lg:w-auto">
          {/* Apply Button */}
          {showFilterButton && (
            <button
              type="submit"
              disabled={disabled}
              className="px-4 py-2.5 text-sm font-medium bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors flex items-center gap-2"
            >
              <svg
                className="w-4 h-4"
                fill="none"
          ...
          {showClearButton && (
            <button
              ...
              disabled={disabled}
              className="px-4 py-2.5 text-sm font-medium text-gray-600 hover:text-gray-800 hover:bg-gray-100 rounded-lg transition-colors flex items-center gap-1 border border-gray-300"
            >
              <svg
                className="w-4 h-4"
                fill="none"
