...
const AttendancePill = ({
  ...
  <div className="flex flex-col items-center gap-2 px-6 py-4 rounded-xl bg-gray-50 border border-gray-100 flex-1">
    ...
    <span
      className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-bold ${present ? 'bg-emerald-50 text-emerald-700 border border-emerald-200' : 'bg-red-50 text-red-600 border border-red-200'}`}
    >
      <span
        className={`w-1.5 h-1.5 rounded-full ${present ? 'bg-emerald-500' : 'bg-red-500'}`}
      />
