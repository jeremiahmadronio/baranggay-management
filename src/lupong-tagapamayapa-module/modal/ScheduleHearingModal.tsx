...
import { scheduleHearing, getMarkers, getBusySlots } from '../../lupong-tagapamayapa-api/LuponCaseManagement-view-api-v2'
import { generatePaanyaya } from './GeneratePaanyaya'
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-3xl overflow-hidden max-h-[95vh] flex flex-col">
        ...
        <div className="flex flex-col md:flex-row overflow-y-auto">
          ...
          <div className="w-full md:w-72 p-5 space-y-4 bg-gray-50/30 shrink-0">
            {/* Selected Date */}
            <div
              className={`rounded-xl border p-3.5 transition-colors ${selectedDate ? 'bg-blue-50 border-blue-100' : 'bg-white border-gray-200'}`}
            >
              {selectedDate ? (
                <>
                ...
                <div>
                  ...
                  <div className="space-y-1.5">
                    {busySlots.map((slot, i) => (
                      <div
                        key={i}
                        className="bg-rose-50 border border-rose-100 rounded-lg px-3 py-2"
                      >
            ...
            <p className="text-[10px] text-gray-400 text-center leading-relaxed">
              Ang Paanyaya (summon letter) ay awtomatikong magbubukas pagkatapos
              mag-schedule.
            </p>
          </div>
        </div>
