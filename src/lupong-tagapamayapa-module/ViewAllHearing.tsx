...
export function ViewAllHearings() {
  const [data, setData] = useState<PageResponse<HearingScheduleDTO> | null>(null);
  ...
  const [detailHearing, setDetailHearing] = useState<HearingScheduleDTO | null>(null);
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
              ...
              <div className="flex flex-col gap-1">
                <label className="text-xs font-medium text-gray-500 pl-1">From</label>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="block w-full pl-10 pr-3 py-2.5 border border-gray-200 rounded-xl bg-white shadow-sm text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                  />
                </div>
              </div>

              {/* Divider */}
              <span className="hidden sm:flex items-end pb-2.5 text-gray-400 font-medium text-sm select-none">
                —
              </span>

              {/* To */}
              <div className="flex flex-col gap-1">
                <label className="text-xs font-medium text-gray-500 pl-1">To</label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <CalendarIcon className="h-4 w-4 text-gray-400" />
                  </div>
            ...
            {hasDateFilter && (
              <div className="flex items-end pb-0 sm:pb-0">
                <button
                  ...
                  className="w-full sm:w-auto mt-0 sm:mt-5 px-4 py-2.5 text-sm font-medium text-gray-600 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 hover:text-gray-800 transition-all shadow-sm"
                >
                  Clear
                </button>
              </div>
        ...
        {hasDateFilter && (
          <div className="mt-4 flex items-center gap-2">
            ...
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium bg-blue-50 text-blue-700 border border-blue-200">
              ...
              {dateFrom ? formatDate(dateFrom + "T00:00:00") : "—"}
              {" "}&rarr;{" "}
                  ...
                  <div className="flex-1 min-w-0 border-t sm:border-t-0 sm:border-l border-gray-100 pt-4 sm:pt-0 sm:pl-6">
                    <div className="flex items-center flex-wrap gap-2.5 mb-2">
                      <h3 className="text-lg font-bold text-gray-900 truncate">
                        ...
                        <span className="text-gray-400 font-normal text-sm mx-1">vs</span>{" "}
