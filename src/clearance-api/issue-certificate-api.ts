...
const FIELD_METADATA: Record<string, FieldMeta> = {
  ...
  building_type: {
    ...
    section: "Document Details",
    type: "select",
    options: ["Residential", "Commercial", "N/A"],
  },
  BUILDING_TYPE: {
    label: "Type",
    section: "Document Details",
  ...
  picture_area: {
    label: "Picture of Area Submitted",
    section: "Requirements Checklist",
    type: "select",
    options: ["Yes", "No", "N/A"],
  },
  land_title: {
    label: "Land Title Submitted",
    section: "Requirements Checklist",
    type: "select",
    options: ["Yes", "No", "N/A"],
  },
  owner_id: {
    label: "Owner's Valid ID Submitted",
    section: "Requirements Checklist",
    type: "select",
    options: ["Yes", "No", "N/A"],
  },
  ...
  secretary_cert_or_cedula: {
    label: "Secretary Cert. / Company Cedula",
    section: "Requirements Checklist",
    type: "select",
    options: ["Yes", "No", "N/A"],
  },
  house_sketch: {
    label: "House Sketch Submitted",
    section: "Requirements Checklist",
    type: "select",
    options: ["Yes", "No", "N/A"],
  },
  police_report: {
    label: "Police Report Submitted",
    section: "Requirements Checklist",
    type: "select",
    options: ["Yes", "No", "N/A"],
  },
  ...
  deceased_or_representative_id: {
    label: "Deceased / Rep. ID Submitted",
    section: "Requirements Checklist",
    type: "select",
    options: ["Yes", "No", "N/A"],
  },
  valid_id_ugong: {
    label: "Valid ID with Ugong Address",
    section: "Requirements Checklist",
    type: "select",
    options: ["Yes", "No", "N/A"],
  },
  moa_agreement: {
    label: "MOA / Agreement (over 10k)",
    section: "Requirements Checklist",
    type: "select",
    options: ["Yes", "No", "N/A"],
  },
  hoa_certificate: {
    label: "HOA Certificate Submitted",
    section: "Requirements Checklist",
    type: "select",
    options: ["Yes", "No", "N/A"],
  },
  ebike_papers: {
    label: "Ebike/E-Trike Papers Submitted",
    section: "Requirements Checklist",
    type: "select",
    options: ["Yes", "No", "N/A"],
  },
  valid_id: {
    label: "Valid ID Submitted",
    section: "Requirements Checklist",
    type: "select",
    options: ["Yes", "No", "N/A"],
  },
  land_title_or_hoa_cert: {
    label: "Land Title / HOA Cert. Submitted",
    section: "Requirements Checklist",
    type: "select",
    options: ["Yes", "No", "N/A"],
  },
  ...
  toda_certificate: {
    label: "TODA Certificate Submitted",
    section: "Requirements Checklist",
    type: "select",
    options: ["Yes", "No", "N/A"],
  },
  tricycle_picture: {
    label: "Tricycle Picture Submitted",
    section: "Requirements Checklist",
    type: "select",
    options: ["Yes", "No", "N/A"],
  },
  // ── Document Details custom inputs ──
  defendant_name: {
    label: "Name of Person with Case",
    section: "Document Details",
    maxLength: 100,
  },
  case_details: {
    label: "Case Details / Description",
    section: "Document Details",
    type: "textarea",
    maxLength: 1000,
  },
