  ...
  const renderPreview = () => {
    switch (template.id) {
      ...
      case 'tricycle-registration':
        return <TricycleRegistrationPreview template={template} customData={customData} />
      case 'working-clearance':
        return <WorkingClearancePreview template={template} customData={customData} />
      case 'certificate-improvement':
        return <ImprovementPreview template={template} customData={customData} />
      case 'technical-permits':
        return <TechnicalPermitPreview template={template} customData={customData} />
      default:
        return <ResidencyPreview template={template} customData={customData} />
    }
  }
      ...
      <div className="flex items-center justify-between mb-4">
        <div>
          ...
          <p className="text-xs text-gray-500 mt-0.5">
            {customData ? "Values from form shown in green" : "Sample data shown in blue"}
          </p>
        </div>
