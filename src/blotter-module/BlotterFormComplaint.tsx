...
// Removed unused ModalProps interface. Use the imported ActionModal's props from SuccessModal.tsx
...
// Removed duplicate ActionModal definition. Use imported ActionModal from reusable/SuccessModal.tsx
...
export default function BlotterEntryForm() {
  ...
  // Removed unused showError helper. Use setSubmitError and setShowErrorModal directly if needed.
    ...
    const init = async () => {
      try {
        ...
        if (escalateId) {
          ...
          const foundNature = natures.find(
            (n) => n.natureName === record.natureOfComplaint,
          );
      ...
      if (mode === "record") {
        ...
        const payload = {
          ...
          livingWithComplainant:
            livingWith !== "" ? livingWith === "true" : undefined,
          natureOfComplaintId: Number(natureId),
          dateOfIncident,
          timeOfIncident: timeOfIncident ? `${timeOfIncident}:00` : undefined,
          placeOfIncident,
        ...
        if (escalateId) {
          resultBlotterNo = await escalateToFormalComplaint(
            escalateId,
            payload,
          );
        } else {
          ...
          >
            ...
            <FormRow cols={3}>
              <FormInput
                ...
                maxLength={11}
                value={rContact}
                onChange={(e) => setRContact(e.target.value.replace(/\D/g, ""))}
              />
              <FormSelect
          ...
          >
            ...
            <FormRow cols={3}>
              ...
              <FormInput
                ...
                onChange={(e) =>
                  setRFormalContact(e.target.value.replace(/\D/g, ""))
                }
              />
            </FormRow>
            <FormInput
            ...
            <FormRow cols={2}>
              <FormSelect
                ...
                onChange={(e) => {
                  setRFormalRelationship(e.target.value);
                ...
                <div className="flex items-center gap-5 mt-2">
                  <label className="flex items-center gap-2 text-sm text-gray-700 cursor-pointer">
                    <input
                      ...
                      name="livingWith"
                      value="true"
                      checked={livingWith === "true"}
                      onChange={() => setLivingWith("true")}
                  ...
                  <label className="flex items-center gap-2 text-sm text-gray-700 cursor-pointer">
                    <input
                      ...
                      name="livingWith"
                      value="false"
                      checked={livingWith === "false"}
                      onChange={() => setLivingWith("false")}
                      className="accent-blue-600"
                    />
                    No
                  </label>
                ...
                >
                  ...
                  <FormRow cols={3}>
                    <FormInput
                      ...
                      value={w.firstName}
                      onChange={(e) =>
                        updateWitness(i, "firstName", e.target.value)
                      }
                    />
                    <FormInput
                      label="Last Name"
                      ...
                      value={w.lastName}
                      onChange={(e) =>
                        updateWitness(i, "lastName", e.target.value)
                      }
                    />
                    <FormInput
                      label="Contact Number"
            ...
            <div id="field-certified">
              ...
              >
                ...
                <p className="text-sm text-gray-700 leading-relaxed">
                  ...
                  that any false statement made herein may subject me to the
                  penalties prescribed by law. I am voluntarily executing this
                  complaint and authorize the Barangay to take appropriate
                  action.
                </p>
              </label>
              {errors.certified && (
