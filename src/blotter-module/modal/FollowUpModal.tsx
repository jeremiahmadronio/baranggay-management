...
import { recordHearingFollowUp } from '../../blotter-api/DocketView'
        ...
        <div className="p-6 space-y-5">
          <div className="space-y-2">
            ...
            <textarea
              ...
              placeholder="What happened? (e.g., Respondent promised to settle next week...)"
              rows={5}
              disabled={saving}
              className="w-full px-4 py-3 text-sm border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-400 resize-none transition-all text-gray-900 shadow-sm"
            />
            {error && (
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 py-3 text-sm font-bold bg-blue-600 text-white rounded-xl hover:bg-blue-700 disabled:opacity-50 transition-all shadow-sm"
          >
            {saving ? (
