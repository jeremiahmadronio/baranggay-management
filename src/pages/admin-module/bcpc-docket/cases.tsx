...
export default function AdminBcpcCaseTable() {
  ...
  const canView = userAccess ? (userAccess.role === 'admin' || userAccess.role === 'rootadmin' || hasBcpcPermission(userAccess, BCPC_PERMISSIONS.VIEW_CASES)) : false;
        ...
        return (
          <div className="flex items-center justify-center gap-1.5">
            <button
              ...
              onClick={(e) => {
                e.stopPropagation();
                if (canView) navigate(`/admin/bcpc-casedetailview?id=${item.id}`);
              }}
    ...
    <div className="min-h-screen bg-gray-50/50">
      <div className="mx-auto max-w-7xl px-4 py-8">
        ...
        <Table
          ...
          variant="resident"
          minRows={SIZE}
          onRowClick={(item) => { if (canView) navigate(`/admin/bcpc-casedetailview?id=${item.id}`); }}
          pagination={{
