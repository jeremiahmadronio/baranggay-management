    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          value: (
            <span
              className={`flex items-center gap-1.5 text-sm font-medium ${admin.status === "ACTIVE" ? "text-green-600" : "text-red-600"}`}
            >
              <span
                className={`w-2 h-2 rounded-full ${admin.status === "ACTIVE" ? "bg-green-500" : "bg-red-500"}`}
              />
              {admin.status}
            </span>
          ),
      ...
      fields: [
        {
          key: "isLocked",
          label: "Account Lock",
          value: admin.isLocked ? "Locked " : "Unlocked ",
          width: "half" as const,
        },
        {
          key: "lockUntil",
          label: "Locked Until",
          value: formatDate(admin.lockUntil),
          width: "half" as const,
        },
        {
          key: "created",
