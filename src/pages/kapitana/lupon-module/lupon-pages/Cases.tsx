...
import {
  mockLuponDashboardStats,
  mockLuponSummaryPage,
...
const KapitanaLuponCases = () => {
  ...
  const fetchStats = async () => {
    ...
    try {
      if (useKapitanaMockData()) {
        setStats(mockLuponDashboardStats());
  ...
  const fetchSummary = useCallback(async (params: LuponSummaryParams) => {
    ...
    try {
      if (useKapitanaMockData()) {
        const res = mockLuponSummaryPage(params);
        setRows(res.content);
...
export default KapitanaLuponCases;
