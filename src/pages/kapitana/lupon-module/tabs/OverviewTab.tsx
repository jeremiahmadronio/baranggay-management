...
export function OverviewTab({
  ...
  return (
    <div className="space-y-5">
      ...
      {!isTerminal && (hasMediationPerm || hasStatusPerm) && (
        <div>
          <p className="text-xs font-medium text-gray-600 uppercase tracking-wider mb-3">
            Quick Actions
          </p>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            ...
            <button
              ...
              className="flex flex-col items-start gap-2 p-5 bg-white border border-gray-200 shadow-sm rounded-xl transition-none text-left focus:outline-none focus-visible:outline-none active:bg-white"
            >
