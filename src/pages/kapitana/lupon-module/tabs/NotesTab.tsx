...
import { type CaseNoteViewDTO } from "../../../../service/lupon-api/LuponCaseManagement-view-api-v2";
import { addCaseNote } from "../../../../service/lupon-api/LuponCaseManagement-view-api-v2";
  ...
  return (
    <div className="space-y-3">
      <SectionCard
        ...
        action={
          !isTerminal && !showNoteInput && hasManageNotes ? (
            <button
        ...
        {showNoteInput && (
          <div className="mb-4 space-y-2">
            ...
            <div className="flex justify-end gap-2">
              ...
              >
                {noteLoading ? (
                  <CircleLoader size="sm" tone="light" className="w-3 h-3" />
                ) : (
