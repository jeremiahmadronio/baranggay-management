        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 sticky top-0 bg-white z-10">
          <div>
            <h3 className="text-base font-semibold text-gray-900">
              Conciliation Follow-up
            </h3>
            <p className="text-sm text-gray-500 mt-1">{caseNumber}</p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="px-6 py-5 space-y-5">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder={
                hasPermission
                  ? "Add any important notes or remarks regarding this conciliation. This will be visible in the case timeline."
