...
import { mockHearingFullDetails } from "../../mock/blotter-kapitana-mock";
...
export function HearingsTab({
  ...
  const handleViewMinutes = async (h: HearingViewDTO) => {
    ...
    try {
      const full = useKapitanaMockData()
        ? mockHearingFullDetails(h.hearingId)
        : await getHearingFullDetails(h.hearingId);
