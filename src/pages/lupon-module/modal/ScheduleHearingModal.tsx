...
const VENUE_OPTIONS = [
  ...
  "Barangay Hall – Conciliation Room",
...
type TimeStatus = "valid" | "end_before_start" | null;
      ...
      <div className="bg-white rounded-lg shadow-lg w-full max-w-3xl overflow-hidden max-h-[90vh] flex flex-col">
        ...
        <div className="flex flex-col md:flex-row overflow-y-auto">
          ...
          <div className="w-full md:w-72 p-5 space-y-4 bg-white shrink-0">
            ...
            {selectedDate && hasTimeConflict && (
              <div className="flex items-start gap-1.5 p-2.5 bg-rose-50 border border-rose-200 rounded-md">
                <AlertTriangleIcon className="w-3 h-3 text-rose-500 shrink-0 mt-0.5" />
                <p className="text-xs text-rose-700 font-medium leading-snug">
                  Your selected time overlaps with an existing schedule.
                </p>
              </div>
            )}
            ...
            >
              ...
              Schedule Conciliation & Generate Summon
            </button>
