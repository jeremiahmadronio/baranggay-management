        ...
        <div className="px-6 py-6 space-y-5">
          {!hasPermission && (
            <div className="flex items-center gap-2 px-4 py-3 bg-amber-50 border border-amber-200 rounded-lg text-sm text-amber-700">
              ...
              <p>You do not have permission to update the case status.</p>
            </div>
          )}
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-2.5 text-sm font-medium border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 bg-white text-gray-900 shadow-sm disabled:bg-gray-50 disabled:text-gray-400 disabled:cursor-not-allowed"
            >
