...
import { updateResidentStatus } from "../../service/resident-api/ResidentsManagement";
  ...
  return (
    <div className="min-h-screen bg-gray-50/50">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <div className="flex items-center gap-3 flex-wrap">
                    ...
                    {/* Update Status button — inline with the badges */}
                    <button
                      type="button"
                      onClick={() => setIsStatusModalOpen(true)}
                      className="flex items-center gap-1.5 text-xs font-medium px-2.5 py-1 rounded-full border border-gray-200 bg-white text-gray-600 hover:bg-gray-50 hover:text-gray-900 hover:border-gray-300 transition-colors"
                    >
            ...
            <div className="flex border-b border-gray-200 px-6 bg-white">
              {(["overview", "cases", "files"] as const).map((tab) => (
                <button
                  ...
                  disabled={loading}
                  className={`py-4 px-1 mr-8 text-sm font-medium capitalize border-b-2 transition-colors -mb-px ${activeTab === tab ? "border-blue-600 text-blue-600" : "border-transparent text-gray-500 hover:text-gray-800 disabled:pointer-events-none"}`}
                >
                  {tab === "cases"
      ...
      <ActionModal
        ...
        type="success"
      >
        The status of <span className="font-semibold text-gray-800">{fullDisplayName}</span> has been successfully updated.
      </ActionModal>
